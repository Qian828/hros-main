...
CREATE TABLE `employee_resignation`  (
  ...
  `emp_id` bigint NULL DEFAULT NULL COMMENT '员工ID（关联employee表）',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '员工离职申请表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `oplog`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2878 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
