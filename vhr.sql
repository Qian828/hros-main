...
) ENGINE = InnoDB AUTO_INCREMENT = 5305 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `employee_promotion`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '员工晋升申请表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of employee_promotion
-- ----------------------------
INSERT INTO `employee_promotion` VALUES (2, 5295, 120, 121, 38, 39, '发大水', '2026-03-27 15:19:02', 5299, NULL, NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1311 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `oplog`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2876 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
