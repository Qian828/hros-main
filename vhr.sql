...
) ENGINE = InnoDB AUTO_INCREMENT = 5309 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `employee_resignation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '员工离职申请表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of employee_resignation
-- ----------------------------
INSERT INTO `employee_resignation` VALUES (1, 5296, 1, '辐射带动', '2026-03-09', 5303, NULL, NULL, 0, NULL, '2026-03-31 11:25:45', '2026-03-31 11:25:45');
INSERT INTO `employee_resignation` VALUES (8, 5305, 1, '发达', '2026-03-31', 5301, '2026-03-31 17:11:52', '发生的', 1, '2026-03-31', '2026-03-31 17:06:05', '2026-03-31 17:11:52');
INSERT INTO `employee_resignation` VALUES (10, 5306, 1, '范德萨', '2026-03-31', 5299, '2026-03-31 17:24:12', '发生的', 1, '2026-03-31', '2026-03-31 17:23:31', '2026-03-31 17:24:11');
INSERT INTO `employee_resignation` VALUES (11, 5307, 1, '范德萨', '2026-03-31', 5303, '2026-03-31 17:32:44', '同意', 1, '2026-03-31', '2026-03-31 17:32:21', '2026-03-31 17:32:44');
...
CREATE TABLE `oplog`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2911 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
