...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (5268, '何婷', '女', '1998-10-08', '150124199510081276', '未婚', 1, '中国', 3, '00000001@qq.com', '15692756582', '江苏盐城', 1, 38, 124, '劳动合同', '本科', '软件工程', '盐城师范学院', '2023-03-03', '在职', '00000001', 1, '2023-03-03', NULL, '2023-03-03', '2024-03-11', NULL);
...
INSERT INTO `employee` VALUES (5272, '11', '男', '1998-10-08', '111222199809098888', '未婚', 1, '', 3, '111@qq.com', '15692756582', '1', 153, 37, 121, '劳动合同', '本科', '法式', '阿帆', '2023-03-03', '在职', '00000003', 0, '2023-03-03', NULL, '2023-03-03', '2023-03-03', NULL);
...
INSERT INTO `hr_role` VALUES (539, 47, 34);
INSERT INTO `hr_role` VALUES (540, 48, 34);
...
INSERT INTO `menu` VALUES (76, '/system/log/**', '/sys/log', 'SysLog', '机构信息', 'fa fa-list', NULL, 1, 36, 1);
...
INSERT INTO `menu` VALUES (79, '/personnel/remove/**', '/per/mv', 'PerMv', '晋升申请与审批', 'fa fa-arrow-up', NULL, 1, 13, 1);
...
INSERT INTO `menu_role` VALUES (1221, 47, 6);
INSERT INTO `menu_role` VALUES (1222, 78, 6);
INSERT INTO `menu_role` VALUES (1223, 63, 6);
INSERT INTO `menu_role` VALUES (1224, 73, 6);
INSERT INTO `menu_role` VALUES (1225, 77, 6);
INSERT INTO `menu_role` VALUES (1226, 50, 6);
INSERT INTO `menu_role` VALUES (1227, 52, 6);
INSERT INTO `menu_role` VALUES (1228, 54, 6);
INSERT INTO `menu_role` VALUES (1229, 55, 6);
INSERT INTO `menu_role` VALUES (1230, 56, 6);
INSERT INTO `menu_role` VALUES (1231, 53, 6);
INSERT INTO `menu_role` VALUES (1232, 79, 6);
INSERT INTO `menu_role` VALUES (1233, 51, 6);
INSERT INTO `menu_role` VALUES (1234, 74, 6);
INSERT INTO `menu_role` VALUES (1235, 75, 6);
INSERT INTO `menu_role` VALUES (1236, 76, 6);
INSERT INTO `menu_role` VALUES (1237, 65, 6);
INSERT INTO `menu_role` VALUES (1238, 66, 6);
INSERT INTO `menu_role` VALUES (1239, 67, 6);
INSERT INTO `menu_role` VALUES (1249, 73, 34);
INSERT INTO `menu_role` VALUES (1250, 77, 34);
INSERT INTO `menu_role` VALUES (1251, 48, 34);
INSERT INTO `menu_role` VALUES (1252, 49, 34);
INSERT INTO `menu_role` VALUES (1253, 68, 34);
INSERT INTO `menu_role` VALUES (1254, 69, 34);
INSERT INTO `menu_role` VALUES (1255, 70, 34);
INSERT INTO `menu_role` VALUES (1256, 71, 34);
INSERT INTO `menu_role` VALUES (1257, 72, 34);
INSERT INTO `menu_role` VALUES (1258, 67, 34);
...
CREATE TABLE `oplog`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2858 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `sys_black_list` VALUES (1, '张三', '110101199001011234', '13800138000', '多次旷工且屡教不改，严重影响门店运营', '153', '2026-03-01 10:23:45', NULL, 'admin_hr', '经店长多次警告无效，永久拉黑', 1);
INSERT INTO `sys_black_list` VALUES (2, '李四', '310101199202025678', '13912345678', '违规操作收银系统，造成门店资金损失', '165', '2026-03-02 14:15:30', '2027-03-02 14:15:30', 'hr_li', '赔偿后观察期1年，到期可申请解除', 1);
INSERT INTO `sys_black_list` VALUES (3, '王五', '440101199303039012', '15098765432', '盗窃门店贵重物资，已移交公安机关处理', '167', '2026-03-03 09:08:12', NULL, 'security_hr', '涉及刑事犯罪，永久禁止入职', 1);
INSERT INTO `sys_black_list` VALUES (4, '赵六', '510101199404043456', '18666668888', '恶意散播谣言，破坏团队氛围', '169', '2026-03-04 16:40:22', '2026-06-04 16:40:22', 'hr_wang', '情节较轻，3个月后可重新评估', 1);
INSERT INTO `sys_black_list` VALUES (5, '孙七', '320101199505057890', '17700009999', '试用期内多次迟到早退，考核不合格', '164', '2026-01-05 11:30:00', '2026-03-05 11:30:00', 'hr_zhang', '试用期结束后解除黑名单', 0);
