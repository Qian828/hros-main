...
) ENGINE = InnoDB AUTO_INCREMENT = 5305 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `employee_promotion`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '员工晋升申请表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of employee_promotion
-- ----------------------------
INSERT INTO `employee_promotion` VALUES (2, 5295, 120, 121, 38, 39, '发大水', '2026-03-27 15:19:02', 5299, NULL, '割发代首', 1);
INSERT INTO `employee_promotion` VALUES (3, 5299, 120, 124, 38, 39, '工地发多少', '2026-03-27 20:51:21', 5301, NULL, NULL, 0);
...
INSERT INTO `hr` VALUES (60, '郑雪', '13000130010', '13000130010', '武汉市洪山区', 1, '郑雪', '$2a$10$JTTFom4NKb5SCv8L0F.bKeF58S7oSPT8s7vlmu8G0fz7Po.vjW1Hy', 'https://imgsa.baidu.com/forum/pic/item/a832bc315c6034a8df786e5ac31349540823766e.jpg', NULL, 5303, '2023-03-09,2023-03-14,2023-03-19,2023-03-27,2023-04-04,2023-04-03,2023-03-29');
...
) ENGINE = InnoDB AUTO_INCREMENT = 554 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `menu` VALUES (79, '/personnel/remove/**', '/per/apply', 'PerApply', '晋升申请', 'fa fa-arrow-up', NULL, 1, 13, 1);
INSERT INTO `menu` VALUES (80, '/personnel/remove/**', '/per/approval', 'PerApproval', '晋升审批', 'fa fa-arrow-up', NULL, 1, 13, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1311 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `menu_role` VALUES (1270, 80, 6);
...
INSERT INTO `menu_role` VALUES (1302, 48, 34);
INSERT INTO `menu_role` VALUES (1303, 49, 34);
INSERT INTO `menu_role` VALUES (1304, 68, 34);
INSERT INTO `menu_role` VALUES (1305, 69, 34);
INSERT INTO `menu_role` VALUES (1306, 70, 34);
INSERT INTO `menu_role` VALUES (1307, 71, 34);
INSERT INTO `menu_role` VALUES (1308, 72, 34);
INSERT INTO `menu_role` VALUES (1309, 79, 34);
INSERT INTO `menu_role` VALUES (1310, 67, 34);
...
CREATE TABLE `oplog`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2877 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
